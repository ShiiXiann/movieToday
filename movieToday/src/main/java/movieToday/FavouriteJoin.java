...
public class FavouriteJoin {
	...
	public FavouriteJoin(int id, String movieName, String movieGenre, String movieDescription,
			String movieCasts, float movieDuration, String movieDateRelease, String movieImage) {
		super();
		this.id = id;
